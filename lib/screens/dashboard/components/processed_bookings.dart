...
class ProcessedBookings extends StatelessWidget {
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Expanded(child: Text('Booking time:')),
                                          SizedBox(width: 20),
                                          Expanded(child: Text('1500hrs')),
                                        ],
                                      ),
                                      SizedBox(height: 20),
                                      // Row 6: Phone Number
